...
x = dataset[sample, it, :, 0]
y = dataset[sample, it, :, 1]
z = dataset[sample, it, :, 2]
...
'''
#colors = np.array([[29, 157, 124]  for _ in range(len(x))])  # Default colors others
